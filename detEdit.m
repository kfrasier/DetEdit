...
% This function operates on output from mkTTPP.m and mkLTSAsessions.m. It
...
while (k <= nb)
    ...
    figure(201);clf;
    hds(1) = subplot(3,1,1);  % top panel RL vs Time
    plot(t,y,'.')
    hold on
    if ff2 > 0
        plot(tfd,yfd,'r.')
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    hds(2) = subplot(3,1,2);  % middle panel LTSA
    ...
    ylabel(hc,'Amplitude')
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    hds(3) = subplot(3,1,3);  % bottom panel Inter-Detection Interval
