...
% This script is where all hard-coded inputs for detEdit.m and
% mkLTSsessions.m are set. 
% At a minimum you should change:
%     fn - point it at your TTPP file of interest
%     ltsaDir - where your LTSAs live
